---
title: "'Maarten van Rossem - De Podcast' - #331 Textanalysis of the podcast"
...
#| fig-cap: "This figure combines the document topic visualization and the hierarchical visualization. This figure doesn't have a hover over as this add a lot to the filesize of this document. This figure currently has a bug and doesn't appear to work in Chrome, but it does work in some other browsers."
#| column: page 
...
plt.close() # This is here as it sometimes helps with the bug mentioned above
binsize = 2
